...
Cartas do computador ${cartasC()} - ${pontosFinalC}`)
   ...
   if (((pontosFinalJ > pontosFinalC) && pontosFinalJ < 22) || (pontosFinalC > 21 && pontosFinalJ < 22)) alert('Parabens! Você venceu! ' + String.fromCodePoint(0x1F604) + placar())
   ...
   else if (((pontosFinalC > pontosFinalJ) && pontosFinalC < 22) || (pontosFinalJ > 21 && pontosFinalC < 22)) alert('Que pena! Você perdeu! ' + String.fromCodePoint(0x1F625) + placar())
   ...
   else if ((pontosFinalJ === pontosFinalC) || (pontosFinalJ > 21 && pontosFinalC > 21)) alert('Deu Empate! ' + String.fromCodePoint(0x1F610) + placar())
